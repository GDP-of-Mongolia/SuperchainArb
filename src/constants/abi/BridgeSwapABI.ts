export const BRIDGE_SWAP_ABI = [
	{
		type: 'function',
		name: 'SwapAndBridgeBack',
		inputs: [
			...
			{ name: 'originRouterV2', type: 'address', internalType: 'address' },
			{ name: 'destRouterV2', type: 'address', internalType: 'address' },
			{ name: '_sendHash', type: 'bytes32', internalType: 'bytes32' },
		],
		outputs: [],
	...
	},
	{
		...
		inputs: [
			...
			{ name: 'originRouterV2', type: 'address', internalType: 'address' },
			{ name: 'destRouterV2', type: 'address', internalType: 'address' },
			{ name: 'destContract', type: 'address', internalType: 'address' },
		],
		outputs: [],
		stateMutability: 'nonpayable',
	},
